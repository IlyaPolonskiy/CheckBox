    ...
    private void initViews(){
        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, payInfo(mInputMoney, mInputInfo), Toast.LENGTH_LONG).show();
            }
        });
    }

    private String payInfo(EditText mInputMoney, EditText mInputInfo){
        if (mInputMoney.getText().length() == 0 || mInputInfo.getText().length() == 0){
            return "Сумма: 0\n" + "Оплата: Не выбрано";
        } else {
            return "Сумма: " + mInputMoney.getText().toString() +
                    "\nОплата: " + mInputInfo.getText().toString();
        }
    }
